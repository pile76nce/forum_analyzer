...
/**
 *
 * Klasa <code>Stemmer</code> služi za svođenje reči iz engleskog jezika na osnovni oblik
 *
 * @author Preuzeto sa Interneta
 * @version 1.0
 */
public class Stemmer {
 ...
 m() > 0. */
    ...
    public List<String> stemString(String str) {
        int len = str.length();
        char[] w = new char[257];
        List<String> ret = new ArrayList<String>(100 + (len / 4));
    ...
    public String[] stemStringToArray(String str)
    {
      List<String> ls = stemString(str);

      return ls.toArray(new String[ls.size()]);
    }

    public String stemStringArray(String str)
    {
      List<String> ls = stemString(str);

      StringBuffer sb = new StringBuffer();

      Iterator<String> loI = ls.iterator();

      while (loI.hasNext())
        sb.append(loI.next()).append(" ");
    ...
    public static void main(String[] args) {
        ...
        List l = s.stemString("the a not they an one two three four five six seven eight nine on off no yes Mr "+
          "can be am it all run running runs 32-bit integers");
        System.out.println(l);
        System.out.println("Stem runs: " + s.stemOneWord("runs"));

        l = s.stemString("32-bit integers");
    }
}
