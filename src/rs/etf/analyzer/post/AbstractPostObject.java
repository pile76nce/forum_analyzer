 ...
 * @version 1.0
 */
public class AbstractPostObject implements Post
{
  ...
  public AbstractPostObject(final String asPost) throws Exception
  {
    isPost = asPost;
  ...
  public AbstractPostObject(File document) throws FileNotFoundException, Exception
  {
